import { Controller, Get, Post, Body, Patch, Param, Delete, Res, HttpStatus, UseGuards, Req, UseInterceptors, UploadedFiles } from '@nestjs/common';
...
async create( @Body() body: any, @Req() req: Request, @Res() res: Response, @UploadedFiles() files: multer.File[] ) {
  ...
  @UseGuards(AuthGuard)
  @Get('/type/:type_id')
  async findOne(@Param('type_id') type_id: string, @Res() res: Response) {
